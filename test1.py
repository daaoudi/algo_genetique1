...
# Exemple de vocabulaire pour les mots positifs et négatifs , neutre
vocabulaire = ["excellent", "cher", "mais", "terrible", "fantastique","bon"]
...
# Données d'exemple
data = ["excellent produit", "terrible expérience", "cher mais fantastique", "pas cher mais terrible","bon element"]
